...
class Vessel(svc.db.Document):
    ...
    email  = svc.db.StringField( min_length=3, max_length=255)
    ...
    BLT  = svc.db.StringField( min_length=3, max_length=255)
    ...
    pilots = svc.db.StringField( min_length=3, max_length=255)
    notes = svc.db.StringField( min_length=3, max_length=255)
    tonrate = svc.db.StringField( min_length=3, max_length=255)