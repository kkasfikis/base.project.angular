...
class Breakdown(svc.db.Document):
    ...
    breakdown_status = svc.db.StringField(required = True, min_length=3, max_length= 255)                   #	T
    breakdown_comment = svc.db.StringField(required = True, min_length=3, max_length= 255)                  #	T
    breakdown_info = svc.db.StringField(required = True, min_length=3, max_length= 1500)                    #	T
