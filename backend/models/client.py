...
class ClientPiC(svc.db.EmbeddedDocument):
    ...
    internal_number = svc.db.StringField(required = True, min_length=3, max_length= 255)
...
class Client(svc.db.Document):
    ...
    tax_percentage  = svc.db.StringField( min_length=3, max_length=255)
    ...
    client_zip  = svc.db.StringField( min_length=3, max_length=255)
