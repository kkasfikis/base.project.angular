...
import { FormClassName, FormFieldBase, FormFieldType, SubForm } from 'main/app/ui-components/dynamic-form/dynamic-form.models';
...
export class ClientComponent implements OnInit {
  ...
  formFields : (FormFieldBase | SubForm)[] = [
    {
    ...
    {
      className : FormClassName.SubForm,
      key : 'peopleInCharge',
      order : 18,
      fields : [
        {
