...
import * as data from './client-proforma.ui-config.json'

@Component({
  selector: 'app-client-proforma',
  templateUrl: './client-proforma.component.html',
  styleUrls: ['./client-proforma.component.scss']
})
export class ClientProformaComponent implements OnInit {
